...
const RegisterDebug: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (filledMembers.length > 5) {
      toast({
        title: "❌ Team Size Error",
        description: "You can have maximum 5 team members.",
        variant: "destructive",
      });
      setIsSubmitting(false);
      return;
    ...
    try {
      ...
      if (response.success) {
        ...
        toast({
          ...
          description: "Your team has been successfully registered for DEBUG!",
          variant: "default",
        });
    ...
    <>
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        {[...Array(50)].map((_, i) => (
          <motion.div
            key={i}
            className="absolute w-1 h-1 bg-gradient-to-r from-orange-400 to-red-500 rounded-full opacity-30"
            initial={{
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        {[...Array(8)].map((_, i) => (
          ...
          >
            <div className={`w-8 h-8 bg-gradient-to-r from-orange-500 to-red-500 rounded-lg transform rotate-45`} />
          </motion.div>
        ))}
      </div>
        ...
        <div className="flex justify-between items-center h-[74px]">
          ...
          <div className="hidden md:flex gap-[32px] items-center">
            ...
            >
              ...
              <motion.div
                className="absolute inset-0 bg-gradient-to-r from-orange-500 to-red-500 rounded-lg opacity-0 group-hover:opacity-20"
                initial={{ scale: 0 }}
                whileHover={{ scale: 1 }}
                transition={{ type: "spring", stiffness: 300 }}
              />
      ...
      >
        ...
        <motion.div
          ...
          className="absolute inset-0 bg-gradient-to-br from-orange-900/20 via-red-900/20 to-amber-900/20"
          style={{
            background: `
              ...
              linear-gradient(to bottom right, rgba(154, 52, 18, 0.1), rgba(153, 27, 27, 0.1), rgba(146, 64, 14, 0.1))
            `
          }}
        />
        ...
        >
          ...
          >
            <div className="absolute left-[25.2vw] top-[1.8vw]">
              ...
              <h2 className="text-white text-[2.52vw] min-text-[24px] font-anton">DEBUG</h2>
            </div>
            <div className="absolute right-[3.6vw] top-[3.6vw] text-right">
              <p className="text-white text-[1.32vw] min-text-[14px] font-inter">
                Find the Bug: Master the Art of Problem Solving!
              </p>
            </div>
          </motion.div>
          <motion.img
          ...
          >
            <p className="text-white text-center font-inter text-[1.08vw] min-text-[14px] leading-tight">
              Ready to test your debugging skills? Form a team of 3-5 members and compete in this challenging problem-solving event where you&apos;ll find and fix bugs in real-world scenarios!
            </p>
          </motion.div>
        </motion.div>
        ...
        >
          <motion.h2
            ...
            style={{
              background: "linear-gradient(90deg, #f97316, #ef4444, #dc2626, #f97316)",
          ...
          <motion.div
            className="absolute inset-0 bg-gradient-to-r from-orange-500/20 to-red-500/20 blur-xl rounded-full"
            animate={{
              scale: [1, 1.2, 1],
              opacity: [0.3, 0.6, 0.3],
            }}
        ...
        >
          ...
          <motion.div
            className="absolute inset-0 bg-gradient-to-r from-orange-500/10 to-red-500/10 rounded-3xl blur-3xl"
            animate={{
              scale: [1, 1.1, 1],
              opacity: [0.3, 0.6, 0.3],
            }}
          ...
          >
            <motion.h3
              className="text-xl sm:text-2xl font-audiowide mb-6 text-center bg-gradient-to-r from-orange-400 to-red-500 bg-clip-text text-transparent"
            >
              Team Information
            </motion.h3>
            <motion.div
            ...
            >
              <motion.div
                className="absolute inset-0 bg-gradient-to-r from-orange-500/20 to-red-500/20 rounded-lg blur-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                animate={{
                  scale: [1, 1.05, 1],
                }}
                transition={{
              ...
              <motion.input
                whileFocus={{ scale: 1.02, boxShadow: "0 0 20px rgba(249, 115, 22, 0.5)" }}
                transition={{ type: "spring", stiffness: 300 }}
                type="text"
                id="teamName"
                name="teamName"
                ...
                className={`relative z-10 w-full px-4 py-4 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent font-inter placeholder-gray-500 text-black bg-white/95 backdrop-blur-sm transition-all duration-300 shadow-lg ${
                  errors.teamName ? 'border-red-500 shadow-lg shadow-red-500/25' : 'border-gray-400 hover:border-orange-300'
                }`}
              />
              <AnimatePresence>
                {errors.teamName && (
          ...
          >
            <motion.h3
              className="text-xl sm:text-2xl font-audiowide mb-6 text-center bg-gradient-to-r from-orange-400 to-red-500 bg-clip-text text-transparent"
            >
              Team Members (3-5 members required)
            </motion.h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {formData.teamMembers.map((member, index) => (
                ...
                >
                  <motion.div
                    className="absolute inset-0 bg-gradient-to-r from-orange-500/10 to-red-500/10 rounded-lg blur-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                    animate={{
                      scale: [1, 1.02, 1],
                    }}
                    transition={{
                  ...
                  <div className="space-y-4 relative z-10">
                    <div>
                      ...
                      <motion.input
                        whileFocus={{ scale: 1.02, boxShadow: "0 0 15px rgba(249, 115, 22, 0.3)" }}
                        transition={{ type: "spring", stiffness: 300 }}
                        type="text"
                        value={member.name}
                        ...
                        className="w-full px-3 py-3 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent font-inter placeholder-gray-500 text-black bg-white/95 backdrop-blur-sm transition-all duration-300 shadow-md"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <motion.div
                        whileFocus={{ scale: 1.02, boxShadow: "0 0 15px rgba(249, 115, 22, 0.3)" }}
                        transition={{ type: "spring", stiffness: 300 }}
                        className="w-full flex items-center border-2 rounded-lg bg-white/95 backdrop-blur-sm focus-within:ring-2 focus-within:ring-orange-500 focus-within:border-transparent overflow-hidden transition-all duration-300 shadow-md"
                      >
          ...
          <motion.button
            ...
            className={`relative z-10 mx-auto mt-16 px-20 py-6 bg-gradient-to-r from-orange-600 via-red-600 to-amber-600 border-2 border-white rounded-[50px] text-white font-monsterrat text-2xl flex items-center justify-center gap-4 transition-all duration-300 backdrop-blur-sm shadow-2xl ${
              isSubmitting 
          ...
          >
            {/* Button glow effect */}
            <motion.div
              className="absolute inset-0 bg-gradient-to-r from-orange-500/30 to-red-500/30 rounded-[50px] blur-xl"
              animate={{
                scale: [1, 1.1, 1],
                opacity: [0.3, 0.6, 0.3],
              }}
