...
import { registerForDebug, IndividualRegistration, ApiResponse } from "@/lib/api";
...
const RegisterDebug: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response: ApiResponse = await registerForDebug(formData);
      ...
      if (response.success) {
        ...
        toast({
          ...
          description: "You have been successfully registered for Debug!",
          variant: "default",
        });
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <p className="text-white text-center font-inter text-[1.08vw] min-text-[14px] leading-tight">
              Put your problem-solving skills to the test! Find and fix bugs in code snippets to prove you&apos;re the ultimate debug master!
            </p>
          </motion.div>
        </motion.div>
        ...
        <motion.h2
          ...
          className="text-2xl sm:text-4xl font-audiowide mb-10 text-center whitespace-nowrap bg-gradient-to-r from-orange-400 via-red-500 to-pink-500 bg-clip-text text-transparent"
        >
          Registration Form
        </motion.h2>
        ...
        >
          ...
          <motion.button
            ...
            className={`mx-auto mt-16 px-20 py-6 bg-gradient-to-r from-orange-600 via-red-600 to-pink-600 border-2 border-white rounded-[50px] text-white font-monsterrat text-2xl flex items-center justify-center gap-4 transition-all duration-300 backdrop-blur-sm ${
              isSubmitting 
