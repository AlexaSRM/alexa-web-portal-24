    ...
    try {
      ...
      if (response.success) {
        toast({
          ...
          description: "You've been successfully registered for the Workshop! Check your email for confirmation.",
          variant: "default",
        });
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12 animate-in slide-in-from-bottom-8 duration-1000 delay-300">
            <div className="inline-flex items-center gap-3 mb-4">
              ...
              <h2 className="text-4xl sm:text-6xl font-audiowide bg-gradient-to-r from-blue-400 via-cyan-400 to-teal-400 bg-clip-text text-transparent">
                Join Workshop
              </h2>
              <HiSparkles className="text-4xl text-blue-400 animate-pulse" />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              ...
              <div className="group relative">
                <div className={`relative transition-all duration-300 ${
                  ...
                  <input
                    ...
                    placeholder=" "
                    className={`w-full px-6 py-6 bg-white/10 backdrop-blur-md border-2 rounded-2xl text-white placeholder-transparent focus:outline-none focus:ring-4 focus:ring-blue-500/50 transition-all duration-300 font-inter text-lg ${
                      errors.name ? 'border-red-500' : focusedField === 'name' ? 'border-blue-400' : 'border-white/30'
                    }`}
                  />
                  <label
                    htmlFor="name"
                    className={`absolute left-6 transition-all duration-300 pointer-events-none font-moul ${
                      focusedField === 'name' || formData.name
                        ? 'text-sm text-blue-400 -translate-y-8'
              ...
              <div className="group relative">
                <div className={`relative transition-all duration-300 ${
                  ...
                  <input
                    ...
                    className={`w-full px-6 py-6 bg-white/10 backdrop-blur-md border-2 rounded-2xl text-white placeholder-transparent focus:outline-none focus:ring-4 focus:ring-blue-500/50 transition-all duration-300 font-inter text-lg ${
                      errors.registrationNumber ? 'border-red-500' : focusedField === 'registrationNumber' ? 'border-blue-400' : 'border-white/30'
                    }`}
                  />
                  <label
              ...
              <div className="group relative">
                <div className={`relative transition-all duration-300 ${
                  ...
                  <div className={`w-full flex items-center bg-white/10 backdrop-blur-md border-2 rounded-2xl focus-within:ring-4 focus-within:ring-blue-500/50 transition-all duration-300 overflow-hidden ${
                    errors.phoneNumber ? 'border-red-500' : focusedField === 'phoneNumber' ? 'border-blue-400' : 'border-white/30'
                  }`}>
              ...
              <div className="group relative">
                <div className={`relative transition-all duration-300 ${
                  ...
                  <input
                    ...
                    className={`w-full px-6 py-6 bg-white/10 backdrop-blur-md border-2 rounded-2xl text-white placeholder-transparent focus:outline-none focus:ring-4 focus:ring-blue-500/50 transition-all duration-300 font-inter text-lg ${
                      errors.srmMailId ? 'border-red-500' : focusedField === 'srmMailId' ? 'border-blue-400' : 'border-white/30'
                    }`}
                  />
                  <label
                    htmlFor="srmMailId"
